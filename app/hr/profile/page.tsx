                                ...
                                <div className="flex flex-col divide-y divide-neutral-800 rounded-lg bg-neutral-900/50 backdrop-blur-sm border border-neutral-800">
                                    <div className="p-6 flex items-center justify-between">
                                        ...
                                        <button
                                            ...
                                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${notifications.interviewCompleted ? "bg-purple-600" : "bg-neutral-700"
                                                }`}
                                        >
                                            <span
                                    ...
                                    <div className="p-6 flex items-center justify-between">
                                        ...
                                        <button
                                            ...
                                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${notifications.newInterview ? "bg-purple-600" : "bg-neutral-700"
                                                }`}
                                        >
                                            <span
                                    ...
                                    <div className="p-6 flex items-center justify-between">
                                        ...
                                        <button
                                            ...
                                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${notifications.weeklyReport ? "bg-purple-600" : "bg-neutral-700"
                                                }`}
                                        >
                                            <span
                            ...
                            <section className="mb-12" id="integrations">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="flex flex-col justify-between gap-4 rounded-lg bg-neutral-900/50 backdrop-blur-sm border border-neutral-800 p-6">
                                        ...
                                        <button className="w-full px-5 py-2.5 rounded-lg text-sm font-semibold bg-neutral-800 hover:bg-neutral-700 text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black focus:ring-purple-500 transition-colors">
                                            Подключить
                                        </button>
                                    </div>
                                </div>
