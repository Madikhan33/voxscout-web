...
export default function HRInterviews() {
    ...
    return (
        <div className="flex min-h-screen bg-black">
            ...
            <main className="relative z-10 flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto">
                <div className="mx-auto max-w-7xl">
                    <header className="flex flex-col sm:flex-row flex-wrap justify-between items-start sm:items-center gap-4 mb-8">
                        ...
                        <button className="flex items-center justify-center gap-2 rounded-lg h-10 px-4 bg-purple-600 hover:bg-purple-700 text-white text-sm font-bold transition-colors">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 mb-6">
                        ...
                        <div className="flex gap-3 items-center">
                            <button className="flex h-11 items-center justify-center gap-x-2 rounded-lg bg-neutral-900/50 border border-neutral-800 px-4 hover:border-purple-900/50 transition-all text-sm">
