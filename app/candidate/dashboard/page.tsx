                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="bg-neutral-900/50 backdrop-blur-sm border border-neutral-800 rounded-xl p-6 flex flex-col sm:flex-row items-center gap-6">
                                            ...
                                            <div className="flex flex-col items-center sm:items-start">
                                                ...
                                                <Link href="#" className="text-purple-400 hover:text-purple-300 text-sm font-medium leading-normal mt-2 inline-flex items-center gap-1.5">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div className="border border-neutral-800 rounded-lg p-4 flex flex-col gap-3 hover:bg-neutral-900/80 hover:border-purple-900/50 transition-all">
                                                ...
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <Link href="#" className="text-purple-400 hover:text-purple-300 text-xs font-medium">
                                                        Подробнее
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="bg-neutral-900/50 backdrop-blur-sm border border-neutral-800 rounded-xl p-6">
                                        ...
                                        <div className="flex flex-col gap-4">
                                            {["Senior Product Designer", "UX Researcher", "Lead UI Designer"].map((title, idx) => (
                                                <div key={idx} className="border border-neutral-800 rounded-lg p-3 hover:bg-neutral-900/80 hover:border-purple-900/50 transition-all cursor-pointer">
                                    ...
                                    <div className="bg-neutral-900/50 backdrop-blur-sm border border-neutral-800 rounded-xl p-6">
                                        ...
                                        <div className="flex flex-col gap-4">
                                            <div className="flex items-center gap-3 border border-neutral-800 rounded-lg p-3 hover:bg-neutral-900/80 hover:border-purple-900/50 transition-all cursor-pointer">
                                                <div className="rounded-full size-10 bg-purple-500/20 flex items-center justify-center text-purple-400 font-bold">A</div>
                                                <div>
                                            ...
                                            <div className="flex items-center gap-3 border border-neutral-800 rounded-lg p-3 hover:bg-neutral-900/80 hover:border-purple-900/50 transition-all cursor-pointer">
                                                <div className="rounded-full size-10 bg-purple-500/20 flex items-center justify-center text-purple-400 font-bold">B</div>
                                                <div>
